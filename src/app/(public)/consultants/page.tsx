...
export default function ConsultantsPage() {
  ...
  const inp = { width:'100%', padding:'9px 12px', border:'1px solid #D4CFC5', borderRadius:8, fontSize:13, fontFamily:'inherit', outline:'none', background:'white' }
    ...
    try {
      const res = await fetch('/api/email', {
        ...
        body: JSON.stringify({
          ...
          data: { name: form.name, company: form.company, email: form.email, topic: form.topic, message: form.message },
        }),
      })
